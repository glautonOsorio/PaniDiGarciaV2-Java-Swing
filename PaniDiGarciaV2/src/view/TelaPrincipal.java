...
public class TelaPrincipal extends JFrame {
	...
	public TelaPrincipal() {
		...
		JLabel lblNewLabel = new JLabel("Welcome! John Hearth to Pani di Garcia V2!");
	...
	public void atualizarTabela() {
		...
		model.addRow(new Object[] { "1", "Bolo de Paçoca", "Bolo utilizando paçoca e canela", "40.20", "Bolo", "4" });
